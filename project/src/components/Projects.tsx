              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-900 hover:text-white hover:border-gray-900 px-4 py-2 rounded-lg font-medium transition-all duration-200"
                  >
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <a
                      href={project.githubUrl}
                      className="flex items-center gap-1 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm font-medium"
                    >
